  ...
  return (
    <>
      <div className="keyboard">
        ...
        <button className="input special" style={{backgroundColor: "#ffd100"}} onClick={() => onclick('DOUBLE')}>DOUBLE</button>
        <button className="input special" style={{backgroundColor: "#ff8a00"}} onClick={() => onclick('TRIPLE')}>TRIPLE</button>
