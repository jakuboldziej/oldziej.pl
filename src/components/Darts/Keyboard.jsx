  ...
  return (
    <>
      <div className="keyboard">
        {numbers}
        <button className="input number" onClick={() => handleRound(25, users, game, handleShow, setUsers, specialState, setSpecialState)}>25</button>
        <button className="input number" disabled={specialState[0]} onClick={() => handleRound(0, users, game, handleShow, setUsers)}>0</button>
